...
// ---------------- SERIAL FOR ESP32 ----------------
SoftwareSerial espSerial(11, 10); // RX, TX <--- ADDED
...
void loop() {
  ...
  if (digitalRead(waterSensor) == HIGH) {
    ...
    // Notify ESP32 of no water
    espSerial.println("0,0,0,0,0,0,0"); // <--- ADDED
  ...
  // -------- SEND TO ESP32 (IOT) --------
  // Sending: TDS, pH, NTU, Temp, COD, BOD, SafeStatus
  espSerial.print(tdsValue); espSerial.print(","); // <--- ADDED
  espSerial.print(phValue);  espSerial.print(","); // <--- ADDED
  espSerial.print(ntu);      espSerial.print(","); // <--- ADDED
  espSerial.print(temperature); espSerial.print(","); // <--- ADDED
  espSerial.print(COD);      espSerial.print(","); // <--- ADDED
  espSerial.print(BOD);      espSerial.print(","); // <--- ADDED
  espSerial.println(safe ? 1 : 0);                 // <--- ADDED
